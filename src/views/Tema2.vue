...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
            ...
            .row.mb-5.justify-content-center
              .col-lg-12
                figure(data-aos="fade-down")
                  img(src='@/assets/curso/tema2-banner.png' alt='Introducción')
              .col-lg-11.bg-degrade-gris-horizontal.tarjeta.neg--top.p-4(data-aos="fade")   
                p.mb-0 En los últimos años, las estrategias corporativas se han centrado en dedicar los recursos propios en las actividades consideradas “<em>core</em>” o esenciales para mantener la competitividad en los mercados, externalizando aquellas otras actividades necesarias desde el punto de vista logístico u operativo, pero difíciles de entender por ser ajenas a la cultura de la organización y de la dirección, además de costosas de mantener por ser adquiridas y consumidas en un volumen reducido.

          p.mb-0(data-aos="fade") El desarrollo de la tecnología en los últimos veinte años ha impulsado la prestación de los servicios relacionados con las TIC, de forma acelerada hasta un nivel de madurez que no solo permite su externalización alineada con las actividades “<em>core</em>” del negocio, sino que son parte integral del negocio y forman parte de su cadena de valor, tal y como se referencia en ITIL 4, atendiendo a la denominada cuarta revolución industrial y la transformación digital relacionada.
    ...
    .row.bg-tema2-1.mb-5.mb-md-0
      .col-lg-12.px-lg-2.px-4.py-4.pb-md-5
        .row.align-items-center.justify-content-evenly
          ...
          .col-lg-7.col-md-7.text-white.esquina.p-3(data-aos="fade-left")
            ...
            p.mb-0 Hay que considerar que lo que puede funcionar en un proveedor o en un cliente puede ser ineficiente, inviable o directamente no cobra ningún sentido en otra organización distinta.

    p(data-aos="fade") Además, la aplicación de controles necesita de recursos para su implementación, mantenimiento y que finalmente se verán reflejados en cifras económicas de gastos operativos.

    p.mb-4(data-aos="fade") Otro enfoque habitual es la aplicación de controles técnicos individuales según se van descubriendo situaciones de riesgo que puedan comprometer la información entre el sistema de información proporcionado por el proveedor, los sistemas y las redes de comunicación de los usuarios del cliente de servicios web.

    .tema1-3-2.bloque-texto-a.color-secundario.p-3.p-md-2.mb-4
      .row.m-0.align-items-center.justify-content-between
        .col-lg-8
          .bloque-texto-a__texto.p-4.ms-3
            p.mb-0 Inicialmente, este enfoque puede dar la sensación de un avance progresivo y proporcionado a las necesidades requeridas por la organización, pero ya ha quedado ampliamente demostrado que conduce finalmente a una falta de control y al desgobierno por ser un enfoque reactivo; pero además, por la incertidumbre de cómo los nuevos controles que se implementan acaban afectando la eficacia de aquellos previamente implementados.
        .col-lg-4.mb-4.mb-lg-0
          img(src='@/assets/curso/tema2-1-img2.png', alt='Imagen decorativa', style="width: 270px; margin: 0 auto;")

    p.mb-0(data-aos="fade") El proceso de análisis y evaluación de riesgos habilita a las gerencias a tomar en consideración todos los aspectos de riesgo que son pertinentes al contexto de la actividad de la organización y a sus objetivos estratégicos de modo que, con base en el resultado del proceso que aporta una identificación completa del escenario de riesgos en un informe puedan decidir en su experiencia como gestores (ahora sí) qué situaciones de riesgo no son asumibles, priorizando unas acciones respecto a otras según el impacto financiero, económico, operativo, reputacional  y los recursos requeridos para su control efectivo.
    ...
    .row.mb-5
      .col-md-8.mb-4.mb-md-0(data-aos="fade-right")  
        p En primer lugar, se introducirá en este momento algunos términos y definiciones esenciales para poder entender los fundamentos de las metodologías en gestión del riesgo.
        p Las referencias en este caso están tomadas de la ISO 27000, norma de consenso y alcance internacional, que toma referencias anteriores como la Guía ISO 72:2009 y amplía adicionalmente, proporcionando una visión general de las normas que componen la serie 27000 (como ISO 27017 y 27018 relacionadas con la prestación de servicios de computación en la nube) y que recopila todas las definiciones relevantes a la seguridad de la información de las publicaciones, de manera que en el siguiente recurso didáctico encontrará una explicación al respecto:
          ...
          .row.mb-4
            ...
            .col-md-6(data-aos="fade-left") 
              ...
              ul.lista-ul--color.color-acento-botones
                li 
                  i.fas.fa-play
                  p.mb-0 Por lo general, el nuevo proveedor "negocia esta ayuda". Sin embargo, si los datos deben volver a la empresa, el cliente tendrá que escribir rutinas de importación que se ocupan de las comparaciones de datos necesarias, a menos que el proveedor de servicios 
                    | <em>cloud</em> ofrezca esta rutina. Este punto lleva a evaluar decisiones respecto a la migración, impactando en el interés comercial a largo plazo del proveedor de servicios en cuanto a una portabilidad más fácil, completa y rentable posible.
                li 
                  i.fas.fa-play
          ...
          .row.mb-4
            ...
            .col-md-6(data-aos="fade-right") 
              ...
              ul.lista-ul--color.color-acento-botones
                ...
                li 
                  i.fas.fa-play
                  | La vinculación PaaS se produce en el nivel de ejecución, puesto que las ejecuciones estándar suelen estar muy personalizadas, a fin de operar de modo seguro en el entorno en la nube, por ejemplo, una ejecución Java puede sufrir la eliminación o la modificación de llamadas «peligrosas» por motivos de seguridad. Corresponde a los desarrolladores del cliente entender y tener en cuenta estas diferencias.
                li 
                  i.fas.fa-play
          ...
          .row.mb-5
            ...
            .col-md-6(data-aos="fade-left") 
              ...
              ul.lista-ul--color.color-acento-botones
                li 
                  i.fas.fa-play
                  p.mb-0 Los proveedores de computación IaaS ofrecen máquinas virtuales basadas en hipervisor. Los metadatos de VM y 
                    <em>software</em> se agrupan por motivos de portabilidad (suele hacerse únicamente dentro de la nube del proveedor). La migración entre proveedores es no trivial hasta que se adoptan normas abiertas, como el formato abierto de virtualización (OVF – <em>Open Virtualization Format</em>).
                li 
                  i.fas.fa-play
    ...
    .titulo-tercero.mb-3(data-aos="fade-right") 
      h3 Pérdida de gobernanza

    p.mb-4(data-aos="fade") Al utilizar las infraestructuras de nube, el cliente necesariamente cede el control de una serie de cuestiones que pueden influir en la seguridad al proveedor de servicios <em>cloud</em>, por ejemplo, los términos de uso pueden prohibir el escaneado de puertos, la evaluación de vulnerabilidades y las pruebas de penetración. Además, pueden surgir conflictos entre los procedimientos de refuerzo del cliente y el entorno en nube. Por otra parte, puede ocurrir que los acuerdos de nivel de servicio no incluyan la prestación de dichos servicios por parte del proveedor de servicios <em>cloud</em>, dejando así una laguna en las defensas de seguridad.  
    ...
    .tema1-3-6.bloque-texto-a.color-secundario.p-3.p-md-2.mb-4(data-aos="fade-down") 
      .row.m-0.align-items-center.justify-content-between
        ...
        .col-lg-8  
          .bloque-texto-a__texto.p-4.ms-3
            p.mb-0 Asimismo, el proveedor de servicios <em>cloud</em> puede subcontratar o externalizar servicios a terceros (proveedores desconocidos) que podrían no ofrecer las mismas garantías (como la prestación del servicio de manera legal), ofrecidas por el proveedor o que se produzcan cambios en el control del proveedor de servicios <em>cloud</em>, de modo que provoquen una modificación de los términos y condiciones de sus servicios.
        ...
        .row.justify-content-evenly.p-3.d-flex
          .col-md-3.h-100.mb-4
            ...
            .cajon-azul.px-3.py-4
              ...
              p.mb-0 Si el Proveedor de Servicios <em>Cloud</em> no puede demostrar su propio cumplimiento de los requisitos pertinentes.
          .col-md-3.h-100.mb-4
            .borde-alto
            .cajon-azul.px-3.py-4
              .titulo-azul-degrade.bg-degrade-azul.px-3.py-2.mb-4
                h4.mb-0.text-white Auditoría
              p.mb-0 Si el Proveedor de Servicios <em>Cloud</em> no permite que el cliente lleve a cabo la auditoría.
    ...
    .titulo-tercero.mb-3(data-aos="fade-right") 
      h3 Pérdida de renombre empresarial por la prestación conjunta
    ...
    .titulo-tercero.mb-3(data-aos="fade-right") 
      h3 Error o cancelación de servicio en la nube
    ...
    .row.justify-content-center.mb-5
      .col-md-9(data-aos="fade-right") 
        ...
        p Dicho de otro modo, es posible que a corto o mediano plazo finalicen algunos servicios de computación en la nube. El impacto de esta amenaza para el cliente de servicios <em>cloud</em> es sencillo de entender, ya que puede dar lugar a una pérdida o al deterioro del rendimiento y de la calidad del servicio, así como a una pérdida de la inversión.
        p Además, los errores en los servicios subcontratados al proveedor de servicios <em>cloud</em> pueden repercutir considerablemente sobre la capacidad del cliente de estos servicios para cumplir sus funciones y obligaciones para con sus propios clientes. Así, este puede encontrarse expuesto a la responsabilidad contractual y extracontractual frente a sus clientes, basándose en la negligencia de su proveedor. 
      .col-md-3.col-9(data-aos="fade-left")
        img(src='@/assets/curso/tema2-3-5-img.svg' alt='Imagen decorativa')

    .titulo-tercero.mb-3(data-aos="fade-right") 
      h3 Fallo en la cadena de suministro

    p(data-aos="fade")  Un proveedor de servicios <em>cloud</em> puede subcontratar determinadas tareas especializadas de su cadena «de producción» a terceros. En esta situación, el nivel de seguridad del proveedor de servicios <em>cloud</em> puede estar supeditado al nivel de seguridad de cada enlace y al grado de dependencia de terceros de este.
    ...
    p(data-aos="fade") Un ejemplo importante al respecto es la existencia de una dependencia crítica de un servicio de gestión de identidad o de un inicio de sesión único de un tercero. En este caso, la interrupción del servicio del tercero o de la conexión del proveedor de servicios <em>cloud</em> al servicio o las deficiencias de sus procedimientos de seguridad pueden poner en entredicho la disponibilidad o la confidencialidad de un cliente de servicios <em>cloud</em>, o de hecho, de toda la oferta en la nube.
          ...
          .col-md-12
            ...
            .row.justify-content-center.mb-5
              ...
              .col-md-6.px-2.px-md-4(data-aos="fade-left")
                ...
                p Una forma poco apropiada de la utilización de recursos (los algoritmos de asignación de recursos comunes son vulnerables a la distorsión de la imparcialidad) o una provisión de recursos e inversiones en infraestructura que sea inadecuada, puede dar lugar, desde la perspectiva del proveedor de servicios <em>cloud</em> a:
              ...
              .col-md-7.mb-4.mb-md-0.px-2.px-md-4(data-aos="fade-right") 
                LineaTiempoD.color-acento-contenido
                  ...
                  .row(numero="5" titulo="Selección deficiente de proveedores") 
                    p Desde la perspectiva del cliente de servicios <em>cloud</em>, una selección de proveedores deficiente y una falta de redundancia en el suministrador puede dar lugar a:
                    ...
                    p.mb-0 Este riesgo también puede derivarse de un ataque DDoS y del mal funcionamiento de las aplicaciones debido a una compartimentación deficiente de la aplicación en algunos sistemas de los proveedores de servicios <em>cloud</em>.
      ...
      .col-lg-12.px-lg-5.px-4.py-4.pb-md-5
        .row.justify-content-center
          .col-md-12
            ...
            p.mb-5(data-aos="fade") Este aspecto puede considerarse especialmente importante en el caso de la computación en la nube, debido a que las arquitecturas en la nube necesitan determinadas funciones de alto riesgo. Entre los ejemplos de estas funciones se incluyen los administradores de sistema de los proveedores de servicios <em>cloud</em> y los proveedores de servicios de seguridad gestionada que se ocupan de los informes de detección de intrusiones y de las respuestas a los incidentes. 

          .col-md-8.mb-5
            .cajon.color-acento-contenido.p-4(data-aos="fade-down")
              p.mb-0 A medida que aumenta el uso de la nube, los empleados de los proveedores de servicios <em>cloud</em> se convierten cada vez más en objetivos de las bandas criminales (como ponen de manifiesto los trabajadores de los centros de llamadas del sector de servicios financieros).
          ...
          .row.mb-5
            .col-md-9.mb-4.mb-md-0(data-aos="fade-right") 
              p Las interfaces de gestión de cliente de un proveedor de servicios <em>cloud</em> público son accesibles a través de Internet, y canalizan el acceso a conjuntos de recursos más grandes (que los proveedores tradicionales de alojamiento), por lo que plantean un riesgo mayor, especialmente cuando se combinan con el acceso remoto y las vulnerabilidades del navegador de web.
              p Aquí se incluyen las interfaces de cliente que controlan una serie de máquinas virtuales, y lo que es más importante, interfaces de proveedor de servicios <em>cloud</em> que controlan el funcionamiento de todo el sistema en la nube. Es evidente que los proveedores pueden mitigar este riesgo incrementando la inversión en seguridad.
    ...
    p(data-aos="fade") Los programas espía, la falsificación de IP, los ataques con intermediarios (MITM – <em>Man in the Middle</em>), los ataques por vía alternativa y los ataques en repetición deben considerarse posibles fuentes de amenaza. Además, en ocasiones, el proveedor de servicios <em>cloud</em> no ofrece una cláusula de confidencialidad o de no divulgación o si lo hace, dichas cláusulas no ofrecen garantías suficientes de protección de la información secreta y los conocimientos del cliente que circularán por la nube.

    p.mb-5(data-aos="fade") Asociado a este tipo de riesgo se puede presentar otro llamado <b>Fuga de datos</b> durante la carga/descarga dentro de la nube que se puede ocasionar durante la transferencia de datos entre el proveedor de servicios <em>cloud</em> y el cliente.


    .titulo-personalizado.text-white.mb-4(data-aos="fade-right") 
      h3.mb-0 Eliminación de datos no segura o no eficaz

    p(data-aos="fade") Cuando se cambia de proveedor los recursos se escalan de forma descendente, el <em>hardware</em> físico se reubica, etc., y los datos pueden estar disponibles más allá de la vida indicada en la política de seguridad.
    ...
    AcordionA.tema1-3-4(tipo="a" clase-tarjeta="tarjeta tarjeta--gris")
      ...
      .row.justify-content-center.align-items-center(titulo="Cliente sin delimitación de recursos")
        .col-md-5.mb-4.mb-md-0.ps-md-4
          p El cliente de servicios <em>cloud</em> no ha delimitado de forma efectiva el uso de los recursos abonados y sufre cargas inesperadas en dichos recursos, a través de acciones no maliciosas.
        .col-md-6
    ...
    p(data-aos="fade") Cada arquitectura de nube descansa en una plataforma altamente especializada: el motor de servicio que se sitúa por encima de los recursos físicos de <em>hardware</em> y gestiona los recursos del cliente con distintos niveles de abstracción, por ejemplo, en la nube IaaS, este componente del <em>software</em> puede ser el hipervisor. 
    ...
    .row.mb-5
      ...
      .col-md-6.mb-4.mb-md-0(data-aos="fade-right") 
        p En caso de confiscación de <em>hardware</em> físico a raíz de una orden judicial de las fuerzas policiales o de demandas civiles, la centralización del almacenamiento y el hecho de que varios clientes compartan el <em>hardware</em> físico implica que hay un número mayor de clientes que corren el riesgo de que sus datos se revelen a partes no deseadas.
    ...
    .row.mb-5
      ...
      .col-md-6.mb-4.mb-md-0(data-aos="fade-right") 
        p La computación en la nube plantea varios riesgos relativos a la protección de datos tanto para clientes en nube como para proveedores de servicios <em>cloud</em>. Se deben tener en cuenta varios aspectos:
        p 1- Puede ser difícil para el cliente de servicios <em>cloud</em> (en su función de controlador de datos) comprobar eficazmente el procesamiento de datos que lleva a cabo el proveedor, sin certeza del como se gestionan en conformidad con la ley. Es el cliente el principal responsable del procesamiento de datos personales, incluso cuando dicho procesamiento lo realice el proveedor de servicios <em>cloud</em> CSP en su papel de procesador externo. El incumplimiento de la legislación en materia de protección de datos por parte del controlador, puede dar lugar a la imposición de sanciones administrativas, civiles o penales, que varían en función del país. En nubes federadas, en donde puede haber casos de transferencias múltiples de datos, este problema es aún mayor. Aunque, algunos proveedores de servicios cloud sí proporcionan información sobre sus prácticas de procesamiento de datos. Otros también ofrecen resúmenes de certificación sobre sus actividades de procesamiento y seguridad de datos y los controles de datos a que se someten.
      .col-md-6(data-aos="fade-left") 
        img(src='@/assets/curso/tema2-5-img3.jpg', alt='Imagen decorativa')
      .col-md-12(data-aos="fade-right")
        p 2- Pueden producirse infracciones de la seguridad de los datos que el cliente de servicios <em>cloud</em> no notifique al controlador.
        p 3- El cliente de servicios <em>cloud</em> puede perder el control de los datos procesados por el proveedor de servicios <em>cloud</em>. Este problema aumenta en los casos de transferencias múltiples de datos (por ejemplo, entre nubes federadas).
        p 4- El proveedor de servicios <em>cloud</em> puede recibir datos que no hayan sido recabados legalmente por su cliente (el controlador).
    ...
    .row.mb-
      ...
      .col-md-6(data-aos="fade-left") 
        ...
        p Por ejemplo, si el <em>software</em> se carga por instancia cada vez que una máquina nueva es instanciada, los gastos de licencia para el cliente de servicios <em>cloud</em> podrían aumentar exponencialmente, a pesar de estar utilizando el mismo número de máquinas durante el mismo período. 
        p En el caso de PaaS e IaaS, existe la posibilidad de crear trabajo original en la nube (nuevas aplicaciones, <em>software</em>, etc.). Al igual que con la propiedad intelectual, si no se encuentra protegido por las cláusulas contractuales apropiadas este trabajo original puede verse amenazado. 
        ...
        PasosA.color-acento-botones.mb-5(tipo="n")
          div
            ...
            ul.lista-ul--color.color-acento-contenido
              ...
              li 
                i.fas.fa-play
                p.mb-0 <em>Software</em> que no es de confianza.      
          div
          ...
          div
            ...
            p.text-left En términos generales, el riesgo de que se produzcan catástrofes naturales es más bajo, en comparación con las infraestructuras tradicionales, ya que los proveedores de servicios <em>cloud</em> ofrecen múltiples sitios redundantes y rutas de red por defecto.
            p.text-left Vulnerabilidades:
            ul.lista-ul--color.color-acento-contenido
              li 
                i.fas.fa-play
