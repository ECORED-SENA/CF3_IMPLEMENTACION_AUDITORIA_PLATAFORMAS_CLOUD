    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      .col-8.col-md-4.col-lg-3.mb-4.mb-md-0
        .tarjeta.h-100.d-flex.align-items-center.px-md-3
          figure
            img(src="@/assets/curso/sopa-letras.svg", alt="Texto que describa la imagen")
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Sopa de letras
        p.mb-4 Afianzar algunos de los  conceptos más importantes de los riesgos y la seguridad en servicios cloud.
